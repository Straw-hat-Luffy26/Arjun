...
description: >-
  Client-side patterns: component boundaries, state ownership, data fetching
  and rendering cost.
version: 1.0.0
license: Apache-2.0
author: unknown
...
metadata:
  ...
  output: source.py
  origin: ECC
  imported-from: 04-engineering-practices/frontend-patterns
---
...
**Asked:** “Structure the readings screen so the state has one owner.”
