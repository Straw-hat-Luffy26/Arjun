...
name: api-design
description: >-
  Designing an interface others depend on: resources, versioning, errors,
  and what to make impossible.
version: 1.0.0
license: Apache-2.0
author: unknown
network: none
...
metadata:
  ...
  origin: ECC
  imported-from: 06-platform-infra/api-design
---
# API Design Patterns
...
Designing an interface others depend on: resources, versioning, errors, and
...
**Asked:** “Design the endpoint the inspection app will call, and what it may not do.”
