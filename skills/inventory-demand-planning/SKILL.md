...
description: >-
  Forecasting demand and sizing stock: Holt-Winters and Croston, safety
  stock under dual variability, ABC/XYZ, EOQ and reorder points.
version: 1.0.0
license: Apache-2.0
author: evos
network: none
...
metadata:
  approval-class: none
  output: demand_plan.xlsx
  origin: ECC
  homepage: https://github.com/affaan-m/everything-claude-code
  imported-from: 01-industrial-operations/inventory-demand-planning
---
...
Forecasting demand and sizing stock: Holt-Winters and Croston, safety stock
under dual variability, ABC/XYZ, EOQ and reorder points.
...
`demand_plan.xlsx`, written into this run's workspace and nowhere else.
...
**Asked:** “Set the reorder point and safety stock for the seal kits, given the last two years of draw.”
...
3. `create_xlsx` to produce `demand_plan.xlsx`
