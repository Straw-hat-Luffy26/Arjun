...
description: >-
  Selecting and reviewing carriers: rate negotiation, service-level
  scorecards, capacity commitments and claims.
version: 1.0.0
license: Apache-2.0
author: evos
network: none
...
metadata:
  ...
  output: carrier_review.docx
  origin: ECC
  homepage: https://github.com/affaan-m/everything-claude-code
  imported-from: 09-supply-chain-logistics/carrier-relationship-management
---
...
`carrier_review.docx`, written into this run's workspace and nowhere else.
...
**Asked:** “Review the three road carriers against last quarter's service data before we re-tender.”
...
3. `create_xlsx` to produce `carrier_review.docx`
