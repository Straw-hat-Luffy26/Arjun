...
description: >-
  Idiomatic Python: typing, structure, the standard library's own answers,
...
metadata:
  ...
  output: source.py
  origin: ECC
  imported-from: 04-engineering-practices/python-patterns
---
...
Idiomatic Python: typing, structure, the standard library's own answers, and
...
**Asked:** “Tidy this script to something the next engineer can maintain.”
