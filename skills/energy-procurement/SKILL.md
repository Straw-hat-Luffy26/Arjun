...
description: >-
  Electricity and gas procurement: tariff comparison, demand-charge
  management, PPA evaluation, load profiling and Scope 2 accounting.
version: 1.0.0
license: Apache-2.0
author: evos
network: none
...
metadata:
  ...
  output: energy_analysis.xlsx
  origin: ECC
  homepage: https://github.com/affaan-m/everything-claude-code
  imported-from: 01-industrial-operations/energy-procurement
---
# Energy Procurement
...
`energy_analysis.xlsx`, written into this run's workspace and nowhere else.
...
**Asked:** “Compare our current tariff against the two quoted alternatives at last year's load profile.”
...
3. `create_xlsx` to produce `energy_analysis.xlsx`
