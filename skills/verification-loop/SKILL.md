...
description: >-
  Checking that a change did what it claimed, by running it rather than by
  reasoning about it.
version: 1.0.0
license: MIT
author: unknown
...
metadata:
  ...
  output: review.docx
  origin: ECC
  imported-from: 05-governance-safety/verification-loop
---
...
**Asked:** “Confirm the calculation change did what it claimed.”
