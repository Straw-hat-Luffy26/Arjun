...
description: >-
  Reviewing code for the failures that matter: injection, secrets, unsafe
  defaults, and trust placed in the wrong input.
version: 1.0.0
license: Apache-2.0
author: unknown
network: none
...
metadata:
  ...
  output: review.docx
  origin: ECC
  imported-from: 05-governance-safety/security-review
---
...
**Asked:** “Review the permit service for injection and unsafe defaults.”
