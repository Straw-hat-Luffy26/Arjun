...
description: >-
  Writing code somebody else will maintain: naming, structure, comments that
  earn their place and what to leave out.
version: 1.0.0
license: Apache-2.0
author: unknown
network: none
...
metadata:
  ...
  output: source.py
  origin: ECC
  imported-from: 04-engineering-practices/coding-standards
---
...
**Asked:** “Review this internal tool's source against our standards before it goes to the shift team.”
