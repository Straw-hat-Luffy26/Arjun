...
description: >-
  Postgres specifically: indexing, query plans, transactions, and the
  features worth using instead of application code.
version: 1.0.0
license: Apache-2.0
author: unknown
network: none
...
metadata:
  ...
  origin: ECC
  imported-from: 06-platform-infra/postgres-patterns
---
# PostgreSQL Patterns
...
Postgres specifically: indexing, query plans, transactions, and the features
worth using instead of application code.
...
**Asked:** “This tag lookup takes four seconds. Work out why.”
