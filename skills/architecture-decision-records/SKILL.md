...
description: >-
  Recording a technical decision so the reasoning survives the person who
  made it.
version: 1.0.0
license: Apache-2.0
author: unknown
...
metadata:
  ...
  origin: ECC
  imported-from: 05-governance-safety/architecture-decision-records
---
...
Recording a technical decision so the reasoning survives the person who made
it.
...
**Asked:** “Record why we chose the historian over a time-series database.”
