...
name: rust-testing
description: >-
  Testing Rust: unit and integration boundaries, property tests, and making
  a failure explain itself.
version: 1.0.0
license: Apache-2.0
author: unknown
network: none
...
metadata:
  ...
  output: tests.py
  origin: ECC
  imported-from: 04-engineering-practices/rust-testing
---
...
Testing Rust: unit and integration boundaries, property tests, and making a
...
`tests.py`, written into this run's workspace and nowhere else. Nothing
...
**Asked:** “Write the tests for the unit conversion, including the failure cases.”
