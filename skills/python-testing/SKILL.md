...
name: python-testing
description: >-
  Testing Python: what to assert, fixtures that do not lie, and coverage
...
metadata:
  ...
  output: tests.py
  origin: ECC
  imported-from: 04-engineering-practices/python-testing
---
...
Testing Python: what to assert, fixtures that do not lie, and coverage that
means something.
...
**Asked:** “Write the tests for the wall-thickness calculation.”
