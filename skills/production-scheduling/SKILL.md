...
description: >-
  Sequencing jobs and balancing a line: theory of constraints, SMED
  changeover, OEE analysis and responding to a disruption.
version: 1.0.0
license: Apache-2.0
author: evos
network: none
...
metadata:
  ...
  imported-from: 01-industrial-operations/production-scheduling
---
...
`schedule.xlsx`, written into this run's workspace and nowhere else. Nothing
...
**Asked:** “Unit 2 is down for eight hours. Re-sequence this week and tell me what slips.”
...
3. `create_xlsx` to produce `schedule.xlsx`
