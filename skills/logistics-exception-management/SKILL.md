...
description: >-
  Handling a shipment that has gone wrong: triage, root cause, recovery
  options and what to tell the customer.
version: 1.0.0
license: Apache-2.0
author: evos
network: none
...
metadata:
  approval-class: none
  output: exception_log.docx
  origin: ECC
  homepage: https://github.com/affaan-m/everything-claude-code
  imported-from: 09-supply-chain-logistics/logistics-exception-management
---
...
`exception_log.docx`, written into this run's workspace and nowhere else.
...
**Asked:** “A consignment missed its window at the port. Work out the recovery options.”
...
3. `create_table` to produce `exception_log.docx`
