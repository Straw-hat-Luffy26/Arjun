...
description: >-
  Investigating a non-conformance: NCR lifecycle, 5-Why and Ishikawa root
  cause, CAPA, SPC interpretation and AQL sampling.
version: 1.0.0
license: Apache-2.0
author: evos
network: none
...
metadata:
  ...
  output: ncr_investigation.docx
  origin: ECC
  homepage: https://github.com/affaan-m/everything-claude-code
  imported-from: 01-industrial-operations/quality-nonconformance
---
...
`ncr_investigation.docx`, written into this run's workspace and nowhere
...
**Asked:** “A batch failed incoming inspection on hardness. Work up the NCR and the root cause.”
...
3. `create_docx` to produce `ncr_investigation.docx`
