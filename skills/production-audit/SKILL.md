...
description: >-
  Auditing readiness before something goes live, scored across security,
  data integrity, rollback and operational cover.
version: 1.0.0
license: Apache-2.0
author: unknown
network: none
...
metadata:
  ...
  output: readiness_audit.docx
  origin: community
  imported-from: 01-industrial-operations/production-audit
---
# Production Audit
...
Auditing readiness before something goes live, scored across security, data
integrity, rollback and operational cover.
...
`readiness_audit.docx`, written into this run's workspace and nowhere else.
...
**Asked:** “Audit whether the new transfer line is ready to run, and score it.”

**What the run does:**

1. `search_documents` over the connected collections
2. `read_scoped_file` for anything already in the workspace
3. `create_docx` to produce `readiness_audit.docx`
