...
description: >-
  Classifying goods and clearing them: HS codes, rules of origin, duty and
  landed cost, and the paperwork each move needs.
version: 1.0.0
license: Apache-2.0
author: evos
network: none
...
metadata:
  ...
  output: compliance_note.docx
  origin: ECC
  homepage: https://github.com/affaan-m/everything-claude-code
  imported-from: 09-supply-chain-logistics/customs-trade-compliance
---
...
`compliance_note.docx`, written into this run's workspace and nowhere else.
...
**Asked:** “Classify this pump import and work out the landed cost.”
...
3. `create_docx` to produce `compliance_note.docx`
