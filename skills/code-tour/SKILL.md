...
name: code-tour
description: >-
  Explaining an unfamiliar codebase in the order a newcomer needs it, entry
  point first.
version: 1.0.0
license: Apache-2.0
author: unknown
...
metadata:
  ...
  output: review.docx
  origin: ECC
  imported-from: 05-governance-safety/code-tour
---
# Code Tour
...
**Asked:** “Walk me through the historian collector, entry point first.”
