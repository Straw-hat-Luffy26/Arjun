...
name: tdd-workflow
description: >-
  Writing the test first: red, green, refactor, and what to do when the
  cycle stops being useful.
version: 1.0.0
license: Apache-2.0
author: unknown
network: none
...
metadata:
  ...
  output: tests.py
  origin: ECC
  imported-from: 04-engineering-practices/tdd-workflow
---
...
Writing the test first: red, green, refactor, and what to do when the cycle
stops being useful.
...
**Asked:** “Build the corrosion-rate calculator test first.”
