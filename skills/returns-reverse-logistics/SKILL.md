...
description: >-
  Running returns: disposition rules, restocking and refurbishment
  economics, warranty recovery and shrinkage.
version: 1.0.0
license: Apache-2.0
author: evos
network: none
...
metadata:
  approval-class: none
  output: returns_analysis.xlsx
  origin: ECC
  homepage: https://github.com/affaan-m/everything-claude-code
  imported-from: 09-supply-chain-logistics/returns-reverse-logistics
---
...
Running returns: disposition rules, restocking and refurbishment economics,
warranty recovery and shrinkage.
...
`returns_analysis.xlsx`, written into this run's workspace and nowhere else.
...
**Asked:** “Work out whether refurbishing the returned actuators beats scrapping them.”
...
3. `create_xlsx` to produce `returns_analysis.xlsx`
