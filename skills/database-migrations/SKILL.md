...
description: >-
  Changing a schema safely: forward-only steps, backfills, and never a
  migration that cannot be rolled forward.
version: 1.0.0
license: Apache-2.0
author: unknown
network: none
...
metadata:
  ...
  origin: ECC
  imported-from: 06-platform-infra/database-migrations
---
...
**Asked:** “Add the revision column to the drawing register without downtime.”
