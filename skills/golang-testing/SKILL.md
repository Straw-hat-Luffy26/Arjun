...
name: golang-testing
description: >-
  Testing Go: table-driven tests, fakes over mocks, and keeping a test
...
metadata:
  ...
  output: tests.py
  origin: ECC
  imported-from: 04-engineering-practices/golang-testing
---
# Go Testing Patterns
...
**Asked:** “Write table-driven tests for the tag parser.”
